/-
Vendored from ProjectVD, `VD/MathlibPending/BoundednessCharacteristic.lean`, by Stefan Kebekus (GitHub `kebekus`).
...
import Vendor.ProjectVD.MathlibPending.ProximityBounded
