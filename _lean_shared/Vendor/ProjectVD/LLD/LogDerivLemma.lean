/-
Vendored from ProjectVD, `VD/LLD/LogDerivLemma.lean`, by Stefan Kebekus (GitHub `kebekus`).
...
import Vendor.MathlibPR.PR41529.BorelGrowth
import Vendor.ProjectVD.LLD.LogDerivTwoRadius
