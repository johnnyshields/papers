/-
Vendored from ProjectVD, `VD/LLD/PoissonJensenDeriv.lean`, by Stefan Kebekus (GitHub `kebekus`).
...
-/
import Vendor.MathlibPR.PR41684.MeromorphicLogDeriv
import Vendor.ProjectVD.LLD.PoissonSchwarzDeriv
