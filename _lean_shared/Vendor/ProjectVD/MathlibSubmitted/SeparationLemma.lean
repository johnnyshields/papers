/-
Vendored from ProjectVD, `VD/MathlibSubmitted/SeparationLemma.lean`, by Stefan Kebekus (GitHub `kebekus`).
...
is being upstreamed to Mathlib piece by piece.  It is submitted upstream as Mathlib pull request #42020, `feat: separation lemma of Value Distribution Theory`,
  https://github.com/leanprover-community/mathlib4/pull/42020
