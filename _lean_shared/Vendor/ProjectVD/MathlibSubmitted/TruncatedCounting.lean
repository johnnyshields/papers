/-
Vendored from ProjectVD, `VD/MathlibSubmitted/TruncatedCounting.lean`, by Stefan Kebekus (GitHub `kebekus`).
...
is being upstreamed to Mathlib piece by piece.  It is submitted upstream as Mathlib pull request #41809, `feat: Truncated Counting Function of Value Distribution Theory`,
  https://github.com/leanprover-community/mathlib4/pull/41809
