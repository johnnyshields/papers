/-
Vendored from ProjectVD, `VD/MathlibSubmitted/PoissonJensen.lean`, by Stefan Kebekus (GitHub `kebekus`).
...
is being upstreamed to Mathlib piece by piece.  It is submitted upstream as Mathlib pull request #42475, `feat: establish the Poisson-Jensen formula`,
  https://github.com/leanprover-community/mathlib4/pull/42475
...
import Vendor.MathlibPR.PR41225.CircleIntegrableFunProp
import Vendor.MathlibPR.PR41496.ECanonicalDecomp
