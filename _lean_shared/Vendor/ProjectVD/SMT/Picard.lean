/-
Vendored from ProjectVD, `VD/SMT/Picard.lean`, by Stefan Kebekus (GitHub `kebekus`).
...
import Vendor.ProjectVD.MathlibPending.CharacteristicIsBigOLog
import Vendor.ProjectVD.SMT.SecondMainTheorem
