/-
Vendored from Mathlib pull request #41529, `feat: Émile Borel's classic "Growth Lemma"`,
by Stefan Kebekus (GitHub `kebekus`).

  https://github.com/leanprover-community/mathlib4/pull/41529

The pull request is merged upstream but lands after the Mathlib revision pinned by this
repository, so the file is copied here verbatim, at upstream path `Mathlib/MeasureTheory/Function/BorelGrowth.lean`,
...
not parse; no declaration, statement or proof is changed.
