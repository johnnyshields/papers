...
* Upstream path: `PrimeNumberTheoremAnd/Mathlib/Analysis/Complex/HadamardFactorization/Summability.lean`
...
public import Vendor.PNTPlus.Mathlib.Analysis.Complex.HadamardFactorization
public import Vendor.PNTPlus.Mathlib.Analysis.Complex.ValueDistribution.LogCounting.Growth
public import Vendor.PNTPlus.Mathlib.Analysis.Meromorphic.DivisorHolomorphic
public import Mathlib.Analysis.Meromorphic.TrailingCoefficient
public import Vendor.PNTPlus.Mathlib.Analysis.SpecialFunctions.Log.Dyadic
public import Vendor.PNTPlus.Mathlib.Analysis.SpecialFunctions.Log.PosLog
...
lemma exists_r0_le_norm_divisorZeroIndex₀_val {f : ℂ → ℂ}
  ...
  · have hD0 : D 0 ≠ 0 := by
      ...
      have hneTop0 : meromorphicOrderAt f (0 : ℂ) ≠ ⊤ := by
        ...
        -- Adapted to the pin: `Ne.elim` is not present at Mathlib
        -- `8e45b0548034eeda677a64e1e0b07837390835b6`; `absurd` closes the same goal.
