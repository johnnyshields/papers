...
nonnegative.  The proof is elementary and noncomputational.  The degree-$m$ coefficient is
...
ordinary log-concavity in $\mu$ follow.
\end{abstract}
...
\]
are nonnegative.  This property is stronger than ordinary log-concavity of
$\mu\mapsto F(\mu;x)$ whenever the series converges at a positive value of
$x$.  It has been studied systematically for reciprocal-gamma, gamma-ratio,
...
first coefficient obstruction in the lifted array may explain that threshold.
\end{remark}
