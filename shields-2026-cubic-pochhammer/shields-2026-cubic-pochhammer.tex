...
$r=4$, and left the cubic case $r=3$ open \cite[Conjecture~1]{KarpZhang2024}.
...
for the paired residue blocks of \Cref{sec:kernel}, due to \cite[Lem.~6]{KalmykovKarp2013Ratios} and applied to
multiplicity two in \cite{KarpZhang2024}, and an ordering of beta laws
...
$x\equiv0,1,2,3,4,5\pmod6$.  These values also follow with no appeal to
...
\cite[Def.~3.A.1 and Thm.~3.A.4]{MarshallOlkinArnold2011} --- equivalently, nonincreasing under increasing
...
During the preparation of this work, the author used OpenAI's ChatGPT (GPT-5.6 Sol) and Anthropic's Claude (Claude Opus 4.8) to assist with manuscript drafting and the development of auxiliary verification code.
